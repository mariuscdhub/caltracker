...
export function MacroStats({ remaining, goal, className }: MacroStatsProps) {
    ...
    return (
        <div className={cn("glass-panel p-6 rounded-3xl relative overflow-hidden transition-all hover:scale-[1.01] duration-500", className)}>
                ...
                <div className="flex justify-between items-end px-2 mb-2">
                    <div className="space-y-0.5">
                        ...
                        <div className="flex items-baseline gap-2">
                            <span className="text-6xl font-black text-white tracking-tighter leading-none tabular-nums">{remaining}</span>
                            <span className="text-sm font-bold text-muted-foreground pb-1.5 mobile-hidden">kcal</span>
                        </div>
                    </div>
                    <div className="text-right space-y-1 pb-1">
                        ...
                        <div className="flex items-center gap-2 justify-end">
                            ...
                            <span className="text-xl font-bold text-muted-foreground/80 font-mono tracking-tight tabular-nums">{goal}</span>
                        </div>
                    </div>
                </div>

                {/* Progress Bar */}
                <div className="h-4 w-full bg-black/40 rounded-full overflow-hidden backdrop-blur-sm border border-white/5 mt-4">
                    <div
